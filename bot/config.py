...
DEFAULT_SETTINGS: dict = {
    ...
    "min_volume_24h_usd": 20_000_000,  # мин. 24ч объём на MEXC для пары (только ликвидные)
    "depth_multiplier": 20.0,        # стакан возле цены должен вмещать N позиций
    "depth_range_pct": 0.3,          # диапазон стакана от цены для замера глубины, %
    "max_move_1m_pct": 1.0,          # макс. движение цены за минуту, % (анти-памп)
